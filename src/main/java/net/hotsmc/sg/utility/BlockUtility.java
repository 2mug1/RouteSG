...
public class BlockUtility {
    ...
    public static List<Block> getChestBlocks(Location loc1, Location loc2, World w) {
    ...
    public static List<Block> getEnderChestBlocks(Location loc1, Location loc2, World w) {
