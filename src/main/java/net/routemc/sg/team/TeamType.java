...
public enum TeamType {
    RED(
            ...
            new String[]{
                    ...
                    ChatColor.GRAY + Style.BOLD + "▓▓" + ChatColor.RED + Style.BOLD +"▓▓▓▓▓" + ChatColor.GRAY +Style.BOLD + "▓▓▓",
                    ChatColor.GRAY +Style.BOLD + "▓▓" + ChatColor.RED + Style.BOLD +"▓" + ChatColor.GRAY + Style.BOLD +"▓" + ChatColor.RED + Style.BOLD +"▓" + ChatColor.GRAY + Style.BOLD + "▓▓▓▓▓ " + ChatColor.RED + ChatColor.BOLD + "RED " + ChatColor.WHITE + " has been eliminated!",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.RED +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓" + ChatColor.RED +Style.BOLD + "▓"  + ChatColor.GRAY + Style.BOLD + "▓▓▓▓",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.RED +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓▓" + ChatColor.RED +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓▓",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.RED +Style.BOLD + "▓" + ChatColor.GRAY + Style.BOLD +"▓▓▓▓" + ChatColor.RED +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓",
                    ChatColor.GRAY +Style.BOLD + "▓▓▓▓▓▓▓▓▓▓",
    ...
    AQUA(
            ...
            new String[]{
                    ...
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.AQUA + Style.BOLD + "▓" + ChatColor.GRAY + Style.BOLD + "▓▓▓▓" + ChatColor.AQUA + Style.BOLD +"▓" + ChatColor.GRAY + Style.BOLD +"▓▓ " + ChatColor.AQUA + ChatColor.BOLD + "AQUA " + ChatColor.WHITE + " has been eliminated!",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.AQUA +Style.BOLD + "▓" + ChatColor.GRAY + Style.BOLD + "▓▓▓▓" + ChatColor.AQUA + Style.BOLD +"▓" + ChatColor.GRAY + Style.BOLD +"▓▓",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.AQUA +Style.BOLD + "▓" + ChatColor.GRAY + Style.BOLD + "▓▓▓▓" + ChatColor.AQUA +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓",
                    ChatColor.GRAY + Style.BOLD +"▓▓" + ChatColor.AQUA +Style.BOLD + "▓" + ChatColor.GRAY +Style.BOLD + "▓▓▓▓" + ChatColor.AQUA + Style.BOLD +"▓" + ChatColor.GRAY +Style.BOLD + "▓▓",
                    ChatColor.GRAY + Style.BOLD + "▓▓▓▓▓▓▓▓▓▓",
