...
import me.trollcoding.requires.sidebar.Board;
import me.trollcoding.requires.sidebar.BoardAdapter;
...
public class GameScoreboardAdapter implements BoardAdapter {
    ...
    private static final String SERVER_IP = Style.AQUA + "RouteMC.net";
    private static final String SERVER_IP_MCSG = Style.AQUA + Style.BOLD + "RouteMC.net";
    private static final String MAIN = Style.AQUA;
    private static final String SUB = Style.WHITE;
    private static final String DISPLAY_NAME = Style.RED + Style.BOLD + "Route SG";
    ...
    public List<String> getScoreboard(Player player, Board board) {
        ...
        Settings settings = RouteSG.getSettings();
